    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-md">
        ...
        <div className="border border-zinc-200 p-8 sm:p-10 shadow-sm rounded-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider">Email Address</label>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs font-medium text-zinc-400">Secure Access System</p>
        </div>
      </div>
    </div>
  )
