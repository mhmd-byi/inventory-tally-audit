    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider mb-6 pl-3 border-l-2 border-black">
              Quick Actions
            </h3>
            ...
            {session.user.role === 'admin' && (
              <>
                <button
                  ...
                  className="w-full flex items-center justify-between p-6 border border-zinc-200 bg-white rounded-2xl hover:border-black transition-all group shadow-sm"
                >
            ...
            <button
              onClick={() => router.push('/dashboard/organizations')}
              className="w-full flex items-center justify-between p-6 border border-black bg-black text-white rounded-2xl hover:bg-zinc-800 transition-all shadow-lg group"
            >
              <div className="flex flex-col text-left">
